    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-item">
                <img src="./src/Llantas1.jpg" width="100%" height="50%">
                    <div class="container">
            ...
            <div class="carousel-item">
                <img src="./src/Llantas2.jpg" width="100%" height="100%">
                    <div class="container">
...
<div class="container">
    ...
    <section class="pageSection">
        ...
        <div class="col-md-6">
            ...
            <p><a class="btn btn-secondary" href="services.php" role="button">View services »</a></p>
        </div>
        <div class="col-md-6">
            <h2>Products</h2>
            <p>Donec sed odio dui. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Vestibulum id ligula porta felis euismod semper. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
            <p><a class="btn btn-secondary" href="products.php" role="button">View products »</a></p>
        </div>
        </div>
        </div>
        <hr>
