        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <?php echo (isset($msg)) ?  '<div class="alert alert-danger" role="alert">' . $msg . '</div>' : ''; ?>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="email" <?php echo (isset($element)) ?  'value="' . $element->get_element('email') . '"' : '' ?>>
                </div>
                <div class="form-group">
                    <label for="titulo">Password:</label>
                    <input class="form-control" type="text" name="password" <?php echo (isset($element)) ?  'value="' . $element->get_element('password') . '"' : '' ?>>
                </div>
                <input type="hidden" name="id" <?php echo (isset($element))? 'value="'.$element->get_element('id').'"' : '' ?>>
                <input class="btn btn-primary" type="submit" value="Enviar">
                <a href="admin-users.php" class="btn btn-primary">Volver</a>
            </form>
